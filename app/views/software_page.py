from PySide6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QLabel, QComboBox, QPushButton, QListWidget, QListWidgetItem, QTextEdit, QFrame
...
class SoftwarePage(QWidget):
    ...
    def _build_ui(self):
        ...
        self.targets_lbl.setStyleSheet("color:#9aa4b2;")
        top.addWidget(self.targets_lbl)

        top.addStretch()
        back = QPushButton("← Back")
        back.setStyleSheet("background:#2a2a2a;")
        ...
        l = QVBoxLayout(left)
        l.addWidget(QLabel("Repository Packages"))
        ...
        self.sel_lbl.setStyleSheet("color:#ff6b6b;")
        l.addWidget(self.sel_lbl)
        row.addWidget(left, 40)

        right = QFrame(objectName="Card")
        r = QVBoxLayout(right)
        r.addWidget(QLabel("Deployment Summary"))
        self.summary = QLabel("-")
        self.summary.setStyleSheet("color:#cbd5e1;")
    ...
    def _on_software(self):
        ...
        if self.state.selected_software:
            ...
            self.sel_lbl.setStyleSheet("color:#4ecdc4;")
        else:
